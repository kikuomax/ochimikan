describe('Search', function() {
    it('lowerBound can locate lower bound of 0 in [0, 1, 2]', function() {
	expect(Search.lowerBound([0, 1, 2], 0, cmp)).toBe(0);
    });

    it('lowerBound can locate lower bound of 1 in [0, 1, 2]', function() {
	expect(Search.lowerBound([0, 1, 2], 1, cmp)).toBe(1);
    });

    it('lowerBound can locate lower bound of 2 in [0, 1, 2]', function() {
    ...
    it('lowerBound can locate lower bound of 3 in [0, 1, 2]', function() {
	expect(Search.lowerBound([0, 1, 2], 3, cmp)).toBe(3);
    });

    it('lowerBound can locate lower bound of 2 in [0, 2, 2]', function() {
	expect(Search.lowerBound([0, 2, 2], 2, cmp)).toBe(1);
    });

    it('lowerBound can locate lower bound of 2 in [2, 2, 2]', function() {
	expect(Search.lowerBound([2, 2, 2], 2, cmp)).toBe(0);
    });

    it('lowerBound can locate lower bound of 2 in []', function() {
